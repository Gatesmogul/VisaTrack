  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#fff' }}>
      ...
      >
        ...
        <View style={[styles.warnsms, localStyles.expiredBox]}>
        <View style={[styles.infoCircle, { backgroundColor: 'red' }]}>
            <Text style={styles.infoIconText}>!</Text>
        </View>
        <View style={{ flex: 1 }}>
            <Text style={localStyles.expiredTitle}>Passport Expired</Text>
            <Text style={localStyles.expiredText}>
