...
function validatePhone(value: string) {
  ...
  useEffect(() => {
    AsyncStorage.setItem("contact", JSON.stringify({ email, phone, code, photo }));
...
<View style={styles.phoneRow}>
  ...
  <View style={[styles.inputWrapper, styles.phoneWrapper, phoneError && styles.inputError]}>
    <Ionicons
      name="call-outline"
      size={20}
    ...
    {isValid ? (
      <View style={styles.successBox}>
        ...
        <Text style={styles.successText}>
          We’ll send a verification code to confirm your email and phone number.
        </Text>
      </View>
    ) : (
